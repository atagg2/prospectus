...
In order to successfully accomplish all of the specified research objectives, we will adhere to the following project timeline:
...
\begin{ganttchart}[
  ...
  \ganttbar{VPM application}{10}{12} \\
